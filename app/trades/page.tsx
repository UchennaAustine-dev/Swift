...
//         description: `Exported ${filteredTrades.length} trades.`,
//       });
//     } catch {
...
//   // Columns definition with sorting and rendering
//   const columns = [
//     {
//       key: "id",
//       label: "Trade ID",
...
//         <Button
//           variant="link"
//           className="p-0 h-auto font-mono text-blue-400 hover:text-blue-300"
...
//   // Mobile card render for smaller screen experience
...
//   // Trading stats for header cards
...
//                 className="flex-1"
//               />
//               {/* <Button onClick={handleExport} disabled={isExporting} className="sm:ml-4">
